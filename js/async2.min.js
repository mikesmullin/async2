...
!0)};a.prototype["do"]=a.prototype.then=a.prototype["try"]=a.prototype.begin=a.prototype.start=a.prototype.auto=function(){return this._push(arguments,null)};a.prototype["new"]=a.prototype.flow=a.prototype["with"]=function(){this.beginning_results=[].slice.call(arguments,0);return this};(d=function(a){return function(b){this[a+"_callback"]=b;return this}})&&(a.prototype.beforeAll=a.prototype.before=d("beforeAll"))&&(a.prototype.beforeEach=d("beforeEach"))&&(a.prototype.afterEach=a.prototype.between=
a.prototype.inbetween=d("afterEach"))&&(a.prototype.error=a.prototype["catch"]=a.prototype.rescue=d("error"))&&(a.prototype.success=a.prototype["else"]=d("success"));(c=function(c){return function(){var b;return(b=new a)[c].apply(b,arguments)}})&&(a.serial=a.series=a.blocking=a.waterfall=c("serial"))&&(a.parallel=a.nonblocking=c("parallel"))&&(a["do"]=a.then=a["try"]=a.begin=a.start=a.auto=c("do"))&&(a.end=a["finally"]=a.ensure=a.afterAll=a.after=a.complete=a.done=a.go=c("end"))&&(a["new"]=a.flow=
